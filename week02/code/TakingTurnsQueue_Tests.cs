...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Instead of adding person to the final of the queue it was added to the begining of the queue. 
    ...
    // Defect(s) Found:  Instead of adding the new person to the final of the queue it was added to the begining of the queue.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The same problem the orden on the queue is incorrect.
    ...
    // Defect(s) Found: Tim keeps forever, but the FIFO order is incorrect.
